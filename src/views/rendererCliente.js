...
function buscarCEP() {
    ...
    let cep = document.getElementById('inputCEPCliente')
    console.log(cep)  //
    ...
    fetch(urlAPI)
        ...
        .then(dados => {
            ...
            document.getElementById('inputClient').value = dados.uf
        })
...
frmClient.addEventListener('submit', async (event) => {
    ...
    console.log(nameClient.value, cpfClient.value, emailClient.value, phoneClient.value, cepClient.value, addressClient.value, numberClient.value, 
        complementClient.value, bairroClient.value, cityClient.value, ufClient.value)
